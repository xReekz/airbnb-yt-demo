...
const Banner = () => {
  return (
    <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[800px]">
        <Image src="https://links.papareact.com/0fm" alt='alt' fill className="object-cover object-top" />
        <div className="absolute top-1/2 w-full text-center">
            <p className="text-sm sm:text-lg md:text-2xl font-bold">Not sure where to go? Perfect.</p>
